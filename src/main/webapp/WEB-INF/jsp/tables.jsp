                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-success animated-bar" role="progressbar" aria-valuenow="40" style="width: 40%;">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-danger animated-bar" role="progressbar" aria-valuenow="89" style="width: 89%;">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <label class="checkbox">
                                                        <input class="check" type="checkbox" value="option4">
                                                    </label>
                                                </td>
                                                <td>Steve Sidwell</td>
                                                <td>Photographer</td>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-warning animated-bar" role="progressbar" aria-valuenow="67" style="width: 67%;">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <label class="checkbox">
                                                        <input class="check" type="checkbox" value="option5">
                                                    </label>
                                                </td>
                                                <td>Elena Dobrev</td>
                                                ...
                                                <td>
                                                    <div class="progress">
                                                        <div class="progress-bar progress-bar-info animated-bar" role="progressbar" aria-valuenow="7" style="width: 7%;">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th class="per5">
                                                    <label class="checkbox">
                                                        <input class="check-all" type="checkbox" value="option1">
                                                    </label>
                                                </th>
...
<![endif]-->
        ...
        <script src="assets-xitong/js/pages/tables.js"></script>
    </body>
</html>