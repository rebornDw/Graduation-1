            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="en-location2"></i> Vector maps</h1>
                        <!-- Start .bredcrumb -->
...
<![endif]-->
        ...
        <script src="assets-xitong/plugins/misc/vectormaps/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="assets-xitong/plugins/misc/vectormaps/maps/jquery-jvectormap-world-mill-en.js"></script>
        <script src="assets-xitong/js/jquery.sprFlat.js"></script>
        <script src="assets-xitong/js/app.js"></script>
        <script src="assets-xitong/js/pages/maps-vector.js"></script>
    </body>
</html>