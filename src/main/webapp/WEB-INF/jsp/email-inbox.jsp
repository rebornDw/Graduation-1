            ...
            <div class="content-wrapper">
                ...
                <div class="outlet">
                    ...
                    <div id="email-sidebar">
                        <!-- Start #email-sidebar -->
                        <div class="p15">
                            <a id="write-email" href="email-write" class="btn btn-danger btn-block uppercase"><i class="im-quill"></i> compose</a>
                        </div>
                        <ul id="email-nav" class="nav nav-pills nav-stacked">
                            <li><a href="email-inbox"><i class="ec-archive"></i> Inbox <span class="notification blue">27</span></a>
                            </li>
                            ...
                            <div class="email-list col-lg-12">
                                <table class="table table-striped table-hover table-fixed-layout non-responsive">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">Twitter</a>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">FC Barcelona Fans</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">ADATA</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                ...
                                <span class="text-muted small ml10">If you unable to see this message please click bellow ...</span>
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">Monitor.US</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">service@intl.paypal.com</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">Jonh Stanton</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">Golden Sans Holiday</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">me, Girlfriend <span class="count-msg">(2)</span></a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">Support, me <span class="count-msg">(17)</span></a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
                                        ...
                                        <tr>
                                            ...
                                            <td class="email-subject"><a href="email-read">support</a>
                                            </td>
                                            <td class="email-intro">
                                                <a href="email-read">
...
<![endif]-->
        ...
        <script src="assets-xitong/js/pages/email.js"></script>
    </body>
</html>