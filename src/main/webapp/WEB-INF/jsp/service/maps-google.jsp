            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="im-map2"></i> Google maps</h1>
                        <!-- Start .bredcrumb -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body">
                                    <div id="gmap-geolocation" style="width:100%;height:300px;"></div>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body">
                                    <div id="gmap-routes" style="width:100%;height:300px;"></div>
                                </div>
                            </div>
                            <!-- End .panel -->
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Street panorama</h4>
                                </div>
                                <div class="panel-body">
                                    <div id="gmap-street-panorama" style="width:100%;height:300px;"></div>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
...
<![endif]-->
        ...
        <script src="assets-xitong/plugins/misc/gmaps/gmaps.js"></script>
        ...
        <script src="assets-xitong/js/pages/maps-google.js"></script>
    </body>
</html>