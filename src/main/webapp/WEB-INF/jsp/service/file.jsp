                ...
                <div class="outlet">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br>
                            <form id="fileupload" action="server/php/" method="POST" enctype="multipart/form-data" class="">
...
<![endif]-->
        ...
        <script src="assets-xitong/plugins/file/jquery.ui.widget.js"></script>
        <script src="assets-xitong/plugins/file/tmpl.min.js"></script>
        <script src="assets-xitong/plugins/file/load-image.min.js"></script>
        <script src="assets-xitong/plugins/file/canvas-to-blob.min.js"></script>
        <script src="assets-xitong/plugins/file/jquery.blueimp-gallery.min.js"></script>
        <script src="assets-xitong/plugins/file/jquery.iframe-transport.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload-process.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload-image.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload-audio.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload-video.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload-validate.js"></script>
        <script src="assets-xitong/plugins/file/jquery.fileupload-ui.js"></script>
        <script src="assets-xitong/js/jquery.sprFlat.js"></script>
        <script src="assets-xitong/js/app.js"></script>
        <script src="assets-xitong/js/pages/file.js"></script>
    </body>
</html>