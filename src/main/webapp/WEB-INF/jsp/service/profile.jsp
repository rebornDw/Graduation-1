                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="panel panel-default plain profile-widget">
                                ...
                                <div class="panel-heading white-bg pl0 pr0">
                                    <img class="profile-image img-responsive" src="assets-xitong/img/profile-cover.jpg" alt="profile cover">
                                </div>
                                <div class="panel-body">
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="profile-avatar">
                                            <img class="img-responsive" src="assets-xitong/img/avatars/132.jpg" alt="@roybarberuk">
                                        </div>
                                    </div>
