            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-12 heading">
                        <h1 class="page-header"><i class="st-grid"></i> Grid system</h1>
                        <!-- Start .bredcrumb -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Grid 6</h4>
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="panel panel-default">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Grid 4</h4>
                                </div>
                                <div class="panel-body">
                                    grid 4
                                </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="panel panel-default">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Grid 3</h4>
                                </div>
                                <div class="panel-body">
                                    grid 3
                                </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="panel panel-default">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Grid 2</h4>
                                </div>
                                <div class="panel-body">
                                    grid 2
                                </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-default">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Grid 8</h4>
                                </div>
                                <div class="panel-body">
                                    grid 8
                                </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="panel panel-default">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Grid 9</h4>
                                </div>
                                <div class="panel-body">
                                    grid 9
                                </div>
