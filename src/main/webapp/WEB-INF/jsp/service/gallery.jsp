...
<![endif]-->
        <!-- Css files -->
        <!-- Icons -->
        <link href="assets-xitong-xitong/css/icons.css" rel="stylesheet" />
        <!-- jQueryUI -->
        <link href="assets-xitong-xitong/css/sprflat-theme/jquery.ui.all.css" rel="stylesheet" />
        <!-- Bootstrap stylesheets (included template modifications) -->
        <link href="assets-xitong-xitong/css/bootstrap.css" rel="stylesheet" />
        <!-- Plugins stylesheets (all plugin custom css) -->
        <link href="assets-xitong-xitong/css/plugins.css" rel="stylesheet" />
        <!-- Main stylesheets (template main css file) -->
        <link href="assets-xitong-xitong/css/main.css" rel="stylesheet" />
        <!-- Custom stylesheets ( Put your own changes here ) -->
        <link href="assets-xitong-xitong/css/custom.css" rel="stylesheet" />
        <!-- Fav and touch icons -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="assets-xitong-xitong/img/ico/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets-xitong-xitong/img/ico/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="assets-xitong-xitong/img/ico/apple-touch-icon-72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="assets-xitong-xitong/img/ico/apple-touch-icon-57-precomposed.png">
        <link rel="icon" href="assets-xitong-xitong/img/ico/favicon.ico" type="image/png">
    ...
    <body>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu email" role="menu">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="assets-xitong-xitong/img/avatars/128.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="assets-xitong-xitong/img/avatars/129.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="assets-xitong-xitong/img/avatars/130.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                                    ...
                                    <li class="mail-list clearfix">
                                        <a href="#">
                                            <img src="assets-xitong-xitong/img/avatars/131.jpg" class="mail-avatar pull-left" alt="avatar">
                                            <p class="name">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown">
                                <a href="#" data-toggle="dropdown">
                                    <img class="user-avatar" src="assets-xitong-xitong/img/avatars/48.jpg" alt="SuggeElson">SuggeElson</a>
                    ...
                    <div class="sidebar-panel-content fullwidth pt0">
                            ...
                            <ul class="chat-ui bsAccordion">
                                    ...
                                    <ul class="in">
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/49.jpg" alt="@chadengle">Chad Engle
                                        ...
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/54.jpg" alt="@alagoon">Anthony Lagoon</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/52.jpg" alt="@koridhandy">Kory Handy</a>
                                            <span class="status"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/50.jpg" alt="@divya">Divia Manyan</a>
                                            <span class="status"><i class="en-dot"></i></span>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="in">
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/51.jpg" alt="@kolage">Eric Hofman</a>
                                            <span class="status online"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/55.jpg" alt="@mikebeecham">Mike Beecham</a>
                                            <span class="status online"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/53.jpg" alt="@derekebradley">Darek Bradly</a>
                                            <span class="status online"><i class="en-dot"></i></span>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/56.jpg" alt="@laurengray">Lauren Grey</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/49.jpg" alt="@chadengle">Chad Engle</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/58.jpg" alt="@frankiefreesbie">Frankie Freesibie</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/57.jpg" alt="@joannefournier">Joane Fornier</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                        <li>
                                            <a href="#" class="chat-name">
                                                <img class="chat-avatar" src="assets-xitong-xitong/img/avatars/59.jpg" alt="@aiiaiiaii">Alia Alien</a>
                                            <span class="status offline"><i class="en-dot"></i></span>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <div class="chat-box">
                            ...
                            <ul class="chat-ui chat-messages">
                                <li class="chat-user">
                                    <p class="avatar">
                                        <img src="assets-xitong-xitong/img/avatars/49.jpg" alt="@chadengle">
                                    </p>
                                ...
                                <li class="chat-me">
                                    <p class="avatar">
                                        <img src="assets-xitong-xitong/img/avatars/48.jpg" alt="SuggeElson">
                                    </p>
                    ...
                    <div class="row">
                        <div class="gallery">
                            ...
                            <div class="gallery-inner">
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix sea" data-my-order="1">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/1.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/1.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix city" data-my-order="2">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/2.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/2.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix city" data-my-order="3">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/3.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/3.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix nature" data-my-order="4">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/4.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/4.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix nature" data-my-order="5">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/5.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/5.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix nature" data-my-order="6">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/6.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/6.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix sea" data-my-order="7">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/7.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/7.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix sea" data-my-order="8">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/8.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/8.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix vegetables" data-my-order="9">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/9.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/9.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix vegetables" data-my-order="10">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/10.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/10.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix sea" data-my-order="11">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/11.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/11.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mix city" data-my-order="12">
                                    <a href="#" class="thumbnail">
                                        <img src="assets-xitong-xitong/img/gallery/12.jpg" alt="image">
                                    </a>
                                    <div class="gallery-image-controls">
                                        <div class="action-btn">
                                            <a class="gallery-image-open btn btn-primary btn-round tipB" title="Open image" href="assets-xitong-xitong/img/gallery/12.jpg"><i class="ec-search"></i></a>
                                            <a class="gallery-image-download btn btn-primary btn-round tipB" title="Download" href="#"><i class="st-download"></i></a>
                                            <a class="gallery-image-delete btn btn-primary btn-round tipB" href="#" title="Delete"><i class="ec-trashcan"></i></a>
                                        </div>
                                    </div>
        ...
        <!-- Javascripts -->
        <!-- Load pace first -->
        <script src="assets-xitong-xitong/plugins/core/pace/pace.min.js"></script>
        <!-- Important javascript libs(put in all pages) -->
        <script src="assets-xitong-xitong/js/jquery-1.8.3.min.js"></script>
        <script>
        window.jQuery || document.write('<script src="assets-xitong-xitong/js/libs/jquery-2.1.1.min.js">\x3C/script>')
        </script>
        <script src="http://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
        <script>
        window.jQuery || document.write('<script src="assets-xitong-xitong/js/libs/jquery-ui-1.10.4.min.js">\x3C/script>')
        </script>
        <!--[if lt IE 9]>
  <script type="text/javascript" src="assets-xitong-xitong/js/libs/excanvas.min.js"></script>
  <script type="text/javascript" src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
  <script type="text/javascript" src="assets-xitong-xitong/js/libs/respond.min.js"></script>
<![endif]-->
        <!-- Bootstrap plugins -->
        <script src="assets-xitong-xitong/js/bootstrap/bootstrap.js"></script>
        <!-- Core plugins ( not remove ever) -->
        <!-- Handle responsive view functions -->
        <script src="assets-xitong-xitong/js/jRespond.min.js"></script>
        <!-- Custom scroll for sidebars,tables and etc. -->
        <script src="assets-xitong-xitong/plugins/core/slimscroll/jquery.slimscroll.min.js"></script>
        <script src="assets-xitong-xitong/plugins/core/slimscroll/jquery.slimscroll.horizontal.min.js"></script>
        <!-- Resize text area in most pages -->
        <script src="assets-xitong-xitong/plugins/forms/autosize/jquery.autosize.js"></script>
        <!-- Proivde quick search for many widgets -->
        <script src="assets-xitong-xitong/plugins/core/quicksearch/jquery.quicksearch.js"></script>
        <!-- Bootbox confirm dialog for reset postion on panels -->
        <script src="assets-xitong-xitong/plugins/ui/bootbox/bootbox.js"></script>
        <!-- Other plugins ( load only nessesary plugins for every page) -->
        <script src="assets-xitong-xitong/plugins/charts/sparklines/jquery.sparkline.js"></script>
        <script src="assets-xitong-xitong/plugins/charts/pie-chart/jquery.easy-pie-chart.js"></script>
        <script src="assets-xitong-xitong/plugins/forms/icheck/jquery.icheck.js"></script>
        <script src="assets-xitong-xitong/plugins/forms/tags/jquery.tagsinput.min.js"></script>
        <script src="assets-xitong-xitong/plugins/forms/tinymce/tinymce.min.js"></script>
        <script src="assets-xitong-xitong/plugins/misc/highlight/highlight.pack.js"></script>
        <script src="assets-xitong-xitong/plugins/misc/countTo/jquery.countTo.js"></script>
        <script src="assets-xitong-xitong/plugins/misc/gallery/jquery.magnific-popup.min.js"></script>
        <script src="assets-xitong-xitong/plugins/misc/mixitup/jquery.mixitup.min.js"></script>
        <script src="assets-xitong-xitong/js/jquery.sprFlat.js"></script>
        <script src="assets-xitong-xitong/js/app.js"></script>
        <script src="assets-xitong-xitong/js/pages/gallery.js"></script>
    </body>
</html>